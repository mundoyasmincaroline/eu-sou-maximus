      ...
      <section className="relative isolate overflow-hidden py-24 lg:py-32">
        ...
        <div className="mx-auto max-w-7xl px-5 lg:px-10">
          ...
          <h1 className="mt-6 font-display text-[clamp(3rem,8vw,7rem)] font-black leading-[0.95]">
            {cms.program.heroTitle.split(" ").slice(0, 2).join(" ")} <br /><span className="italic text-gradient-gold">{cms.program.heroTitle.split(" ").slice(2).join(" ") || cms.program.heroTitle}</span>
          </h1>
